...
export const internships = [
  {
    ...
    tags: ['活动运营', '全流程推进', '竞品分析'],
    summary:
      '主导常驻活动改版与 4 场+ 线上运营活动落地，以竞品分析持续优化运营策略。',
    highlights: [
      '机制设计与全流程推进：主导完成常驻活动改版，通过重构榜单机制与多层级任务体系拉动参与，设计分层激励及付费点，活动上线后日均流水提升 36%；围绕营收、停留时长、社交关系链三类目标协助推进 4 场+ 活动落地，负责前期策划与内容宣发，统筹活动执行进度，协助跨部门资源配置。',
  ...
  categories: [
    {
      ...
      items: [
        {
          name: '暖暖系列',
          note: '暖暖环游世界 / 奇迹暖暖 / 闪耀暖暖 · 长期游玩，累计充值约 100 元（主要用于版本礼包），剧情已推进至最新章节',
        },
      ],
    },
    {
      ...
      items: [
        {
          name: '无限暖暖',
          note: '搭配师等级满级 · PC 端 200h+、安卓平板端 1000h+ · 剧情已推进至最新章节',
    ...
    },
    {
      ...
      items: [
        ...
        { name: '纪念碑谷', note: '冒险解谜类 · 游玩时长 100h+ · 全通关' },
...
export const skills = [
  ...
  },
  {
    ...
    lines: [
      ...
      '熟练使用 SQL、漏斗分析、Excel（VLOOKUP / 数据透视表 / 图表），具备数据处理与分析能力，有效支持决策优化。',
    ],
  },
  {
    group: '协调沟通',
