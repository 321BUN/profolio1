...
export const internships = [
  {
    ...
    highlights: [
      '活动策划与全流程推进：主导完成常驻活动改版，通过重构榜单机制与多层级任务体系拉动参与，活动上线后日均流水提升 36%；围绕营收、停留时长、关系沉淀三类目标协助推进 4 场+ 线上运营活动落地，撰写活动规则与宣发内容，统筹活动执行进度，协助跨部门资源配置。',
  ...
  categories: [
    {
      ...
      items: [
        {
          name: '暖暖系列',
          note: '暖暖环游世界 / 奇迹暖暖 / 闪耀暖暖 / 无限暖暖 · 无限暖暖搭配师等级满级，PC 端 200h+、安卓平板端 1000h+，累计充值约 100 元（主要用于版本礼包），剧情已推进至最新章节',
