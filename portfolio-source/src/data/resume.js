...
export const internships = [
  {
    ...
    summary:
      '主导常驻活动改版与 4 场+ 线上运营活动落地，以竞品分析持续优化运营策略。',
    highlights: [
      '活动策划与机制设计：主导完成常驻活动改版，通过重构榜单机制与多层级任务体系拉动参与，设计分层激励及付费点，活动上线后日均流水提升 36%；围绕营收、停留时长、社交关系链三类目标协助推进 4 场+ 活动落地，负责前期策划与内容宣发，统筹活动执行进度，协助跨部门资源配置。',
      '竞品追踪与分析：追踪同类游戏化社交产品的活动玩法与用户反馈，输出竞品分析报告并持续优化策略，提炼可复用策略并推动落地。',
    ],
    metrics: [
      { k: '日均流水', v: '+36%' },
      { k: '落地活动', v: '4 场+' },
  ...
  },
  {
    ...
    highlights: [
      '内容策划与传播：独立负责产品的软性内容策划与传播，累计产出约 60 篇原创内容及多平台分发（小红书 / 抖音 / 微博），打造多篇爆款内容（单篇最高点赞量 7800+，浏览量 1.6w+）；跟踪各平台互动数据，依据用户反馈快速调整内容方向，具备从数据中提炼用户偏好、优化传播策略的能力。',
    ],
    metrics: [
      { k: '原创内容', v: '约 60 篇' },
      { k: '单篇最高赞', v: '7800+' },
...
export const projects = [
  {
    ...
    highlights: [
      '跨界合作与活动策划：参与多领域杰出人物的访谈合作，以及多高校、文化组织的联合传播活动；参与女书文化主题活动策划，协助设计线上线下联动传播方案，吸引超 5000 人次参与。',
...
// AIGC 自媒体账号（小红书 ·「转念花开」）
export const aigcAccount = {
  id: 'aigc-zhuannian',
  badge: 'Social Media · AIGC 自媒体',
  name: '小红书治愈系 / 慢生活个人自媒体账号',
  meta: '「转念花开」· 小红书 · 内容创作者 · 持续更新中',
  role: '内容创作者 · 策划 / AIGC 制作 / 运营',
  period: '持续更新中',
  covers: `${B}aigc-covers.jpg`,
  tags: ['AIGC 视频', '小红书运营', '诗意文案', '治愈系美学'],
  summary:
    '个人 AIGC 自媒体账号「转念花开」：以豆包、即梦生成东方美学治愈系风景动态视频，剪映剪辑成片，围绕治愈 / 慢生活主题在小红书持续更新，累计获赞与收藏 9200+。',
  highlights: [
    'AIGC 视频生产：使用豆包、即梦生成东方美学风格的治愈系动态视频（雪夜灯屋、江南雨巷、四时节气、秋夜星湖等主题），以剪映完成剪辑与节奏把控，形成「AI 视频 + 原创诗意短句 + 精准话题标签」的稳定内容模板。',
    '文案与话题运营：为每条视频撰写契合画面的原创诗意文案（如「借清秋的夜，揽一池星河入梦」「晚来天欲雪，能饮一杯无」），搭配 #治愈系风景 #雪一落就美成了诗 #慢时光慢生活 等话题标签，稳定切入治愈 / 慢生活内容流量池。',
    '账号数据表现：累计获赞与收藏 9200+、粉丝 1300+，多篇笔记点赞 50+；评论区互动活跃，用户自发以诗句跟帖续写文案。',
  ],
  metrics: [
    { k: '获赞与收藏', v: '9200+' },
    { k: '粉丝', v: '1300+' },
  ...
  sign: '最能治愈人心的是这世间的风景~',
  link: 'https://www.xiaohongshu.com/user/profile/687ca8c3000000001e002524',
}

// 游戏经历（个人画像，按品类分组）
export const gaming = {
  summary:
    '10 多年游戏经历，覆盖换装、乙女向、开放世界 RPG、卡牌、ACT 与休闲等品类，日常关注游戏 UCG 内容、游戏 IP 联动、潮玩文创等跨赛道品牌合作活动。',
  categories: [
    {
      cat: '换装游戏',
      items: [
        {
          name: '暖暖系列',
          note: '暖暖环游世界 / 奇迹暖暖 / 闪耀暖暖 · 游玩时长 300h+',
        },
      ],
    },
    {
      ...
      items: [
        {
          name: '无限暖暖',
          note: '搭配师等级满级 · PC 端 200h+、安卓平板端 1000h+ · 累计充值约 100 元（主要用于版本礼包）· 剧情已推进至最新章节',
          report: { id: 'nikki', label: '《无限暖暖》拆解报告' },
        },
        {
          name: '原神',
          note: '冒险等阶 40 级+ · 游玩时长 300h+ · 蒙德 / 璃月 / 霜月 / 至冬剧情推进完毕',
          report: { id: 'genshin', label: '《原神》拆解报告' },
        },
        { name: '洛克王国：世界', note: '50 级+ · 游玩时长 100h+' },
      ],
    },
    {
      cat: '乙女向游戏',
    ...
    },
    {
      cat: 'MOBA',
      items: [
        { name: '王者荣耀', note: '游玩时长 1000h+ · 5 个以上账号均满级 · 最高段位王者' },
      ],
    },
    {
      cat: '卡牌游戏',
      items: [
        { name: '苏丹的游戏', note: '游玩时长 200h+ · 达成约 50 种结局' },
      ],
    },
    {
      cat: 'ACT 游戏',
      items: [
        { name: '双人成行', note: '游玩时长 100h+ · 全通关' },
      ],
    },
    {
      cat: '休闲游戏',
      items: [
        { name: '梦想城镇', note: '模拟经营类 · 游玩时长 300h+ · 40 级+' },
        { name: '欢乐斗地主', note: '棋牌类 · 游玩时长 500h+' },
        { name: '纪念碑谷1+2', note: '冒险解谜类 · 游玩时长 100h+ · 全通关' },
        { name: '滚动的天空', note: '音游跑酷类 · 游玩时长 100h+ · 全通关' },
      ],
    },
  ],
}
...
export const skills = [
  ...
  },
  {
    group: '营销与节点运营',
    lines: [
      '具备市场需求文档撰写经验，有参与品牌策划/营销、关键营销节点运营的实践经验；',
      '了解达人营销生态，能协助进行达人分层运营与种草模型提炼。',
    ],
  },
  {
    group: '数据驱动',
    lines: [
      '对互联网用户产品领域心怀热爱，对泛娱乐赛道有持续热情与探索欲，乐于拥抱新技术、学习新技能。',
      '有数据支持决策的实战经验，熟练使用 SQL、Excel（VLOOKUP / 数据透视表 / 图表），能独立完成漏斗拆解，具备数据处理与分析能力，有效支持决策优化。',
    ],
  },
  {
    group: '协调沟通',
...
export const searchSections = [
  ...
  { id: 'campus', label: '校园经历', text: campus.map(itemText).join(' ') },
  {
    id: 'works',
    label: '作品集',
    text: [
      itemText(portfolio),
      itemText(aigcAccount),
      ...reportList.map((r) => `${r.title} ${r.game} ${r.sub} ${r.summary} ${r.toc.join(' ')}`),
    ].join(' '),
  },
  {
    id: 'gaming',
