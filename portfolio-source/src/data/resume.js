...
export const internships = [
  {
    ...
    highlights: [
      '活动策划与全流程推进：主导完成常驻活动改版，通过重构榜单机制与多层级任务体系拉动参与，活动上线后日均流水提升 36%；围绕营收、停留时长、关系沉淀三类目标协助推进 4 场+ 活动落地，负责前期策划、方案设计与内容宣发，统筹活动执行进度，协助跨部门资源配置。',
      '竞品追踪与分析：追踪同类产品的活动机制与用户反馈，输出竞品分析报告并持续优化策略，成功提炼可复用策略并推动落地。',
    ],
    metrics: [
      { k: '日均流水', v: '+36%' },
      { k: '落地活动', v: '4 场+' },
...
export const skills = [
  ...
  },
  {
    ...
    lines: [
      ...
      '熟练使用 SQL、Excel（VLOOKUP / 数据透视表 / 图表），具备数据处理与分析能力，有效支持决策优化。',
    ],
  },
  {
    group: '协调沟通',
